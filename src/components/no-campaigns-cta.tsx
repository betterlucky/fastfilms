  ...
  return (
    <div className="space-y-8 py-12 text-center">
      <div className="space-y-4">
        <h2 className="font-bold text-3xl text-gray-900">No Upcoming Screenings</h2>
      ...
      <div className="items-center justify-center flex flex-col p-8 gap-4">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
          <div className="items-center flex flex-col gap-4 text-center">
            <div className="items-center flex gap-x-3">
              <div className="items-center justify-center ring-1 ring-white/20 flex p-2 bg-white/10 rounded-lg">
                <CalendarIcon className="size-6 text-white" />
              </div>
              <h3 className="font-semibold text-sm text-white leading-6">Schedule screenings</h3>
            </div>
          ...
          <div className="items-center flex flex-col gap-4 text-center">
            <div className="items-center flex gap-x-3">
              ...
              <h3 className="font-semibold text-sm text-white leading-6">Invite friends</h3>
            </div>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="items-center flex flex-col gap-4 text-center">
            <div className="items-center flex gap-x-3">
              ...
              <h3 className="font-semibold text-sm text-white leading-6">Watch together</h3>
            </div>
            <p className="text-sm text-muted-foreground">
      ...
      <div className="text-center">
        ...
        <h3 className="mt-2 font-semibold text-sm text-gray-900">No campaigns</h3>
