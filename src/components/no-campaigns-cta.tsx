        ...
        <Card>
          ...
          <CardFooter>
            <Button asChild variant="outline" className="w-full">
              <Link href="/contact">Suggest a Film</Link>
            </Button>
          </CardFooter>
        </Card>
        ...
        <Card>
          ...
          <CardFooter>
            <Button asChild className="w-full">
              <Link href="/notify-me">Get Notified</Link>
            </Button>
          </CardFooter>
        </Card>
      </div>
      ...
      <div className="pt-8">
        ...
        <div className="flex justify-center gap-4 mt-4">
          <Button asChild variant="ghost" size="icon">
            <Link href="https://twitter.com/fastfilms" target="_blank" rel="noopener noreferrer">
          ...
          <Button asChild variant="ghost" size="icon">
            <Link href="https://facebook.com/fastfilms" target="_blank" rel="noopener noreferrer">
          ...
          <Button asChild variant="ghost" size="icon">
            <Link href="https://instagram.com/fastfilms" target="_blank" rel="noopener noreferrer">
