    ...
    <div className="space-y-8 py-12 text-center">
      <div className="space-y-4">
        ...
        <p className="mx-auto max-w-2xl text-xl text-gray-600">
          We don't have any upcoming community cinema events at the moment, but
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-6 md:grid-cols-2">
        <Card>
          ...
          <CardContent>
            <p className="text-gray-600">
              Have a film you'd love to see in your community? Let us know and
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-gray-600">
              Sign up to be notified when new community cinema events are
      ...
      <div className="pt-8">
        <p className="text-gray-500">
          Or follow us on social media to stay updated with the latest news and
          events
        </p>
